      ...
      <form class="needs-validation mx-auto card" style="width:65%;" method="post" novalidate>
        <div class="form-row">
          <div class="col-md-6 mb-3">
            <input type="text" class="form-control" id="validationCustom01" name="employee_no" placeholder="Employee Number" required>
        ...
        <div class="form-row">
          ...
          <div class="col-md-4 mb-3">
            <input type="text" class="form-control" id="validationCustom02" name="emergencycontact" placeholder="Emergency Contact (09XXXXXXXXX)" required>
            <div class="invalid-feedback">
              Please enter a valid contact number.
            </div>
          </div>
        ...
        <button class="btn btn-primary" type="submit" name="btn">Create Faculty</button>
		...
		<?php
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				$action="Created a Faculty Account";
				...
				$query=mysqli_query($con,"INSERT into activity_log(username,role,action,action_time) values('$username1','$role1','$action','$action_time')");
					if($query){
						...
						$sql = "INSERT into faculty_info(employee_no, username, password, role, fname, sname, mname, age, bdate, gender, address, contact, email, emergencyperson, emergencycontact) VALUES('$employee_no', '$username', '$password', '$role', '$fname', '$sname', '$mname', '$age', '$bdate', '$gender', '$address', '$contact', '$email', '$emergencyperson', '$emergencycontact')";
