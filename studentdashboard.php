...
?>
		...
		<body>
			...
			<section class="container section-1">
				<div class="row">
					<!--Tabs header-->
					<div class="col-xl-9 tab-nav">
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							<a class="nav-link active modules" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Enrolled<span class="badge badge-dark">7</span></a>
							<a class="nav-link calendar" id="nav-profile-tab " data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Question Bank</a>
						</div>
						<!--Tab content-->
						<div class="tab-content" id="nav-tabContent">
							...
							<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
								...
								<a class="btn btn-outline-primary enroll" href="#">Enroll</a>
								<div class="clear"></div>
								<?php
								$query = mysqli_query($con, "SELECT * from `subject_list` where target_course = '$target_course' and target_year = '$target_year' ");
								$count = 1;
								...
								?>
									<div class="accordion" id="accordionExample">
										<!--Accordion card-->
										<div class="card">
											<div class="card-header course-<?php echo $count; ?>" onclick="location.href='studentModule.php';" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne" id="headingOne">
												<h4 class="mb-0">
													<span class="title course"><?php echo $row['subject_name']; ?></span>
												</h4>
												<h6 class="mb-0">
													<span class="subject courses"><?php echo $row['subject_code'] . " " . $stud['course'] . "-" . $stud['year'] . $stud['section'] ?></span>
												</h6>
												<h6 class="mb-0">
													<span class="schedule courses">
														<?php
														$query_schedule = mysqli_query($con, "SELECT * from `classroom_info` where target_course = '$target_course' and target_year = '$target_year' ");
														foreach ($query_schedule as $sched) {
															echo $sched['schedule'];
														}
														?>
													</span>
												...
												<div class="sections">
													<h6 class="mb-0">
														<span class="sections-text">9 sections</span>
													</h6>
												</div>
											</div>
										</div>
